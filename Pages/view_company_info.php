<?php
	...
	if (session_status()==NULL) {
      	header ("Location: ../");
      		...
      		if($_SESSION['designation']!="student" && $_SESSION['designation']!="ipoh"){
      		header ("Location: ../");
			}
      	else{ ?>
<!doctype html>
...
<head>
    ...
    <meta charset="utf-8">
	<title>Information of Companies</title>
</head>
...
<body>
  ...
  <?php
	...
	$sql = 'SELECT * FROM company ORDER BY cid ASC'; 
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                   <h4 class="panel-title">
                                     <a data-toggle="collapse" href="#<?php echo $row[0];?>">
                                     <span id = "view">Company Name : </span> <?php echo $row[1]; ?></a>
                                   </h4>
                                 </div>
                                <div id="<?php echo $row[0]; ?>" class="panel-collapse collapse">
                                    <div class="panel-body">
                                       <p>Location : <?php echo $row[2]; ?></p>
                                       <p>HR's Email : <?php echo $row[3]; ?></p>
                                       <p>Job Category : <?php echo $row[4]; ?></p>
                                       <p>Available Position : <?php echo $row[5]; ?></p>
                                    </div>
                                </div>
                              </div>
                          </div>

                            ...
                            <div class="panel panel-default">
                               <div class="panel-heading">
                                  <h4 class="panel-title">
                                     ...
                                     <span id = "view">Username :</span> <?php echo $row[1]?></a>
                                  </h4>
                               </div>
                               <div id="<?php echo $row[0]?>" class="panel-collapse collapse">
                                  <div class="panel-body">
                                   	<p>BSSE Email : <?php echo $row[2]; ?></p>
                                    <p>BSSE Roll : <?php echo $row[0]; ?></p>
                                    
                                   <div class="panel-footer" id = "pannel_footer">
                                    <a class="btn btn-success"
                                     href= "../php_includes/toapprove.php?roll=<?php echo $row['0'];?>&approve=yes">
                                     Approve</a>
                                    <a class="btn btn-danger"
                                     href= "../php_includes/toapprove.php?roll=<?php echo $row['0'];?>&approve=delete">
                                     Delete</a>

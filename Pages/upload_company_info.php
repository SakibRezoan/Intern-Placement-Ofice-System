                ...
                <div class="col-sm-12">
                    <div class="well">
                        <div class="page-header">
                            ...
                            <form role="form" action="../php_includes/toupload_company_info.php" method="post">
                                <div class="form-group">
                                  <label for="cname">Company Name</label>
                                  <input type="text" class="form-control" id="cname" name="cname" required="required" placeholder="Enter Company Name">
                                </div>
                                <div class="form-group">
                                  <label for="location">Company Location</label>
                                  <input type="text" class="form-control" id="location" name="location" required="required" placeholder="Enter Company Location">
                                </div>        
                                <div class="form-group">
                                  <label for="mail">Company HR's Email</label>
                                  <input type="email" class="form-control" id="mail" name="mail" required="required" placeholder="Enter Email of Company HR">
                                </div>
                                <div class="form-group">
                                  <label for="job_cat">Job Category</label>
                                  <input type="text" class="form-control" id="job_cat" name="job_cat" required="required" placeholder="Enter Job Category">
                                </div>
                                <div class="form-group">
                                  <label for="available_pos">Available Position</label>
                                  <input type="number" class="form-control" id="no_of_intern" name="available_pos" required="required" placeholder="Enter how many position available">
                                </div>

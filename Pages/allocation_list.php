<?php
	...
	if (session_status()==NULL) {
      	header ("Location: ../");
      		...
      		if($_SESSION['designation']!="student" && $_SESSION['designation']!="ipoh" && $_SESSION['designation']!="rpo"){
      		header ("Location: ../");
			}
      	else{ ?>
<!doctype html>
                                 ...
                                 <div class="panel panel-default">
                                     <div class="panel-heading">
                                         <div class="panel-title">
                                             <a data-toggle="collapse" href="#<?php echo $row['roll'];?>">
                                             <span id="view">Roll :</span><?php echo $row['roll'];?></a>
                                         </div>
                                     </div>
                                     <div id="<?php echo $row['roll'];?>" class="panel-collapse collapse">
                                         <div class="panel-body"> 
                                             <p>Name :<?php echo $row['name'];?></p>
                                             <p>CGPA :<?php echo $row['cgpa'];?></p>
                                             <?php
											 	$cid = $row['cid'];
											 	$sql = "SELECT company_name,job_cat FROM company WHERE cid=$cid";
												$success = mysqli_query($conn,$sql);
												$comp=mysqli_fetch_assoc($success);
											 ?>
                                             <p>CV : <span id="cv"><a href="../uploads/<?php echo $row['cv'];?>"
                                             title="Download CV" target="_blank">
                                             <?php echo $row['cv'];?></a></span></p>
                                             <p>Company :<?php echo $comp['company_name'];?></p>
                                             <p>Position :<?php echo $comp['job_cat'];?></p>
                                         </div>
                                     </div>
                                 </div>
                        </div> <!-- end panel group -->

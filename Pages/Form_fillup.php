...
<head>
    ...
    <meta charset="utf-8">
	<title>Choice Form Fill Up</title>
</head>
                ...
                <div class="col-sm-12">
                    <div class="well">
                        <div class="page-header">
                            ...
                            <form role="form" action="../php_includes/toformfillup.php" method="post">
                            ...
                            <?php
                                ...
                                $result = mysqli_query( $conn, $sql );
                             	$n=0;
                                while($row = mysqli_fetch_assoc($result)){ $n++; ?>
								
                                <div class="form-group">
                                  <label for="<?php echo $n; ?>">Choice No: <?php echo $n; ?> </label>
                                  
                                  <select class="form-control" id="<?php echo $n; ?>" name="choice[]">
                                <?php  

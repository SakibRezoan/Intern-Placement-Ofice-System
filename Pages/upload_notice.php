                ...
                <div class="col-sm-12">
                    <div class="well">
                        <div class="page-header">
                            <form role="form" action="../php_includes/toupload_notice.php" method="post">
                                <div class="form-group">
                                  <label for="notice_type"><h2> Notice Type</h2></label><br>
                                  <input type="text" class="form-control" id="notice_type" name="type"
                                  required="required" placeholder="Enter What type of Notice it is.">
                                </div>
                                <div class="form-group">
                                  <label for="notice"><h2>Write Notice Content</h2></label><br>
                                  <textarea class="form-control" wrap="hard" name="content" rows="9" id="notice"></textarea>
                                </div>
